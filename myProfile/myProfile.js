...
function edit() {
    ...
    if(!editing) {
        ...
        // Name
        userNameField.innerHTML = "<input id=\"name-input\" type=\"text\" value=\"" + defaultUser.firstName + " " + defaultUser.lastName + "\">";
    ...
    // saving
        ...
        editing = false;
        // Name
        let names = document.getElementById("name-input").value.split(" ");
        defaultUser["firstName"] = names[0];
        defaultUser["lastName"] = names[1];
